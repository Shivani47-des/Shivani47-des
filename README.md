...
* 🌐 Building full-stack applications with **React & JavaScript**
* 🗄️ Working with **MySQL** for data persistence
* 🎨 Styling with **Tailwind CSS**
* 🐳 Learning **Docker** for containerized workflows
* 🧠 Practicing **Data Structures & Algorithms in C / C++**
* 🏗️ Learning **backend fundamentals & system design**
...
A full-stack tourism platform focused on **Jharkhand travel and destination discovery**.

### Key Features

* 🎥 Destination browsing with hover video previews
...
A satellite monitoring and orbital intelligence platform exploring **real-time satellite tracking and collision risk analysis**.

### Key Features

* 🛰️ Live tracking of 10,000+ Starlink satellites
* 📡 Automated conjunction (collision) detection
* ⚡ Risk scoring
